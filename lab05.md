...
- Open the `CI-D` environment you verified in Lab 1 and used in Labs 03 and 04
- In the left navigation, go to Insights > **Measures**

![Example: CI-D measures landing page](images/lab05-cid-measures-landing-page.png)
...
![Example: create TotalRevenue measure](images/lab05-cid-create-TotalRevenue-measure.png)
...
![Example: configure TotalRevenue measure relationship](images/lab05-cid-configure-TotalRevenue-measure-relation.png)

- Click Save and close in the bottom-right corner

![Example: configure TotalRevenue measure attribute](images/lab05-cid-configure-TotalRevenue-measure-attribute.png)
...
![Example: create OrderCount measure](images/lab05-cid-create-OrderCount-measure.png)
...
![Example: create RegistrationCount measure](images/lab05-cid-create-RegistrationCount-measure.png)
...
- Under Measure expression click the '/' button to add the 
...
![Example: create RegistrationRate measure](images/lab05-cid-create-RegistrationRate-measure.png)
...
- In the Add to Rule 2 section on the right side, expand `{{Your user ID}}RegistrationRate : CustomerInsights` (you might need to wait until the RegistrationRate measure is successfully created) and select **`Calculation 1`**, change the specific number operator to `greater than or equal to`, and enter `0.5`
- In the bottom-right corner click Save, then in the bottom-left corner click Run

![Example: create HighValueAdopters segment](images/lab05-cid-create-HighValueAdopters-segment.png)
