# Lab 06 - Optional: Explore AI-Powered Customer Insights
...
![Example: CI-D home page](images/lab06-cid-home-page.png)

![Example: CI-D data prep report](images/lab06-cid-data-prep-report.png)
...
![Example: CI-D insights discovery](images/lab06-cid-insights-discovery.png)

![Example: discovery result for Germany](images/lab06-cid-discovery-germany.png)

![Example: discovery follow-up result for Germany subset](images/lab06-cid-discovery-germany-issue.png)
...
- Open `ColorCloud Aura Accessories` email, and save a copy in the learnt way, using your unique identifier
- Back on the list of emails, open `{{Your user ID}} ColorCloud Aura Accessories`
...
![Example: personalize email with Copilot](images/lab06-cij-personalize-email-with-copilot.png)
...
![Example: create journey from Copilot prompt](images/lab06-cij-create-journey-from-prompt.png)

![Example: review journey created from prompt](images/lab06-cij-review-journey-created-from-prompt.png)

![Example: finalized journey from prompt](images/lab06-cij-journey-from-prompt-final.png)
